...
const pages = [
  ...
  {
    slug: "arborist-tree-risk-assessment-terms-study-guide",
    title: "Arborist tree risk assessment terms study guide",
    description: "Review tree risk terms around likelihood, consequences, targets, defects, mitigation language, and communication limits.",
    headline: "Study tree risk terms without promising safety outcomes.",
    intent: "Candidates who need clearer risk vocabulary while keeping formal assessment, legal conclusions, and safety promises outside a study guide.",
    actions: ["Define targets, likelihood, consequences, and uncertainty separately.", "Practice plain-language explanations for risk observations.", "Keep mitigation wording within study-level examples.", "Avoid guarantees about safety, legal results, or future tree condition."],
  },
  {
    slug: "arborist-soil-amendment-study-boundary",
    title: "Arborist soil amendment study boundary",
    description: "Study soil amendment concepts around testing, organic matter, compaction, pH, nutrient limits, and local recommendation boundaries.",
    headline: "Review soil amendments without guessing at prescriptions.",
    intent: "Candidates learning how amendment decisions depend on evidence, soil conditions, species needs, and qualified local guidance.",
    actions: ["Start with soil testing, site history, and visible symptoms.", "Separate possible deficiencies from confirmed needs.", "Review amendment goals at a concept level.", "Avoid dosage, product, legal, or outcome promises without qualified review."],
  },
  {
    slug: "arborist-municipal-tree-inventory-practice",
    title: "Arborist municipal tree inventory practice",
    description: "Practice municipal tree inventory concepts for IDs, species, condition, maintenance priority, map notes, equity, and data quality.",
    headline: "Turn municipal inventory study into cleaner records.",
    intent: "Candidates connecting tree observations to city maintenance planning without treating study notes as official records or risk decisions.",
    actions: ["Define inventory purpose, fields, and update cadence.", "Use consistent condition and maintenance-priority language.", "Flag missing access, uncertain IDs, and outdated observations.", "Avoid legal, budget, safety, or compliance conclusions from practice records."],
  },
  {
    slug: "arborist-tree-planting-aftercare-study-guide",
    title: "Arborist tree planting aftercare study guide",
    description: "Review planting aftercare around watering, mulch, staking checks, root flare visibility, monitoring, and expectation setting.",
    headline: "Study aftercare as monitoring, not a survival guarantee.",
    intent: "Candidates reviewing how early follow-up supports establishment while preserving site-specific and qualified guidance boundaries.",
    actions: ["Connect aftercare tasks to establishment goals.", "Review warning signs and monitoring intervals at a concept level.", "Separate owner communication from site-specific prescriptions.", "Avoid guarantees about survival, growth, safety, or warranty outcomes."],
  },
  {
    slug: "arborist-root-pruning-concept-review",
    title: "Arborist root pruning concept review",
    description: "Study root pruning concepts around root zones, construction conflicts, timing, stress, documentation, and qualified supervision.",
    headline: "Keep root pruning review conceptual and cautious.",
    intent: "Candidates who need vocabulary and decision context without field instructions, engineering advice, or survival promises.",
    actions: ["Review root-zone function and likely stress pathways.", "Identify when conflicts require qualified review.", "Document assumptions, limits, and follow-up needs.", "Avoid procedural cuts, engineering decisions, or safety and survival guarantees."],
  },
  {
    slug: "arborist-wildfire-defensible-space-study-guide",
    title: "Arborist wildfire defensible space study guide",
    description: "Review defensible-space study concepts around vegetation, access, local rules, maintenance, documentation, and fire-agency referral.",
    headline: "Study defensible space with local authority boundaries.",
    intent: "Candidates reviewing vegetation-management language without replacing fire-code, insurance, legal, or emergency guidance.",
    actions: ["Identify vegetation, structure, access, and maintenance concepts.", "Compare study notes with current local fire-authority guidance.", "Separate general pruning and spacing terms from code compliance.", "Avoid fire-safety, insurance, legal, or compliance guarantees."],
  },
  {
    slug: "arborist-tree-failure-case-study-review",
    title: "Arborist tree failure case study review",
    description: "Practice reviewing tree failure scenarios for observations, likely contributing factors, uncertainty, documentation, and referral limits.",
    headline: "Review tree failure cases without overclaiming causes.",
    intent: "Candidates learning cautious post-event language that separates visible facts, possible factors, and qualified investigation needs.",
    actions: ["Separate observed damage from inferred cause.", "List site, weather, defect, and maintenance factors cautiously.", "Note evidence gaps and referral needs.", "Avoid blame, legal conclusions, or future-safety guarantees."],
  },
  {
    slug: "arborist-client-dispute-communication-guide",
    title: "Arborist client dispute communication guide",
    description: "Practice client-dispute wording for scope, observations, uncertainty, next steps, documentation, and no legal or refund advice.",
    headline: "Study tense client communication with clearer boundaries.",
    intent: "Candidates strengthening professional communication while keeping legal, insurance, refund, and liability decisions outside the study tool.",
    actions: ["Restate scope, dates, observations, and unresolved facts.", "Use calm wording for uncertainty and next steps.", "Keep documentation organized for qualified review.", "Avoid legal advice, blame assignment, refund decisions, or outcome promises."],
  },
  {
    slug: "arborist-tree-species-selection-climate-study-guide",
    title: "Arborist tree species selection climate study guide",
    description: "Study species selection with climate stress, mature size, soil, pests, diversity, maintenance, and local reference checks.",
    headline: "Match species study notes to future site stress.",
    intent: "Candidates reviewing species selection in changing conditions without claiming guaranteed performance or climate resilience.",
    actions: ["List site constraints, climate stressors, and maintenance goals.", "Compare species traits with current regional references.", "Balance diversity, pest pressure, and mature size.", "Avoid guarantees about survival, resilience, property value, or long-term outcomes."],
  },
  {
    slug: "arborist-work-zone-traffic-control-concept-review",
    title: "Arborist work zone traffic control concept review",
    description: "Review work-zone traffic-control concepts around visibility, access, communication, authority, documentation, and qualified planning.",
    headline: "Study traffic-control concepts without jobsite instructions.",
    intent: "Candidates reviewing safety vocabulary while leaving actual traffic-control plans to current regulations, permits, and qualified supervision.",
    actions: ["Identify public access, visibility, and communication concepts.", "Separate study vocabulary from traffic-control plan design.", "Check current local regulations, permits, and employer procedures.", "Avoid procedural instructions, compliance claims, or public-safety guarantees."],
  },
];
